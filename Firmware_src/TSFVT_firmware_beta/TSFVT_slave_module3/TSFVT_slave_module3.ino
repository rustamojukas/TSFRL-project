  ...
  while(measureStart){
    ...
    switch (moduleSwValue) {
      ...
      case 1:
        ...
        if (moduleMeasuredData[0] < 65 || moduleMeasuredData[0] > 79){
    ...
    switch (moduleSwValue) {
      ...
      case 1:
        ...
        if (moduleMeasuredData[1] < 65 || moduleMeasuredData[1] > 79){
    ...
    switch (moduleSwValue) {
      ...
      case 1:
        ...
        if (moduleMeasuredData[2] < 65 || moduleMeasuredData[2] > 79){
    ...
    switch (moduleSwValue) {
      ...
      case 1:
        ...
        if (moduleMeasuredData[3] < 65 || moduleMeasuredData[3] > 79){
